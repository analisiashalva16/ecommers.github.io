...
<div class="container">
    ...
    <form class="justify-content-center align-items-center" action="<?= $base_url . 'barang/edit' . $edit['idbarang'] ?>" method="post">
        <div>
        ...
        <div>
            ...
            <select class="form-select mb-3" name="iddist" id="" >
                ...
                ?>
                    <option value="<?= $barang['iddist'] ?>"><?= $barang['iddist'] ?></option>
                <?php }  ?>
            </select>
        </div>
        <div>
